...
public class CustomAdapterMYClinents extends RecyclerView.Adapter<CustomAdapterMYClinents.MyViewHolder>  {
    ArrayList personNames;
    Context context;
    public CustomAdapterMYClinents(Context context, ArrayList personNames) {
